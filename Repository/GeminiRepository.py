#Clase de repositorio, tiene comunicacion directa con el agente de IA
...
class GeminiRepository:
    ...
    def __init__(self):
        ...
        #Obtiene la apike desde el archivo .env
    ...
    #Se comunica con el modelo de IA y devuelve la respuesta
